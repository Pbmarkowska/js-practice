...
2. Czym jest hoisting?
   Hoisting to defaultowe zachowanie Javascriptu, w którym deklaracja zmiennej jest przesuwana na samą górę obecnego scope'u (funkcyjnego lub globalnego) zanim kod się wykona. Hoistowane są tylko deklaracje, nie inicjalizacje.  
...
8. Czym jest parametryzacja w testach API?
...
9. Co to jest mockowanie w testach API?
...
10. Dlaczego sprawdzamy Content-Type w API?
...
11. Co sie stanie jesli serwer zwroci json, ale naglowek jest text/html?
